...
namespace SpaceBox
{
    public partial class Inicio : Form
    {
        ...
        private void maskedTextBox1_Validated(object sender, EventArgs e)
        {
            ...
            {
                ErrorG.Clear();
                xtxt_tablero = Convert.ToInt32(maskedTextBox1.Text);
                Datos.xtxt_tablero = maskedTextBox1.Text;
                // Establecer el tamaño del TableLayoutPanel
            }
        }
        ...
        private void maskedTextBox2_Validated(object sender, EventArgs e)
        {
            ...
            {
                ErrorG.Clear();
                ytxt_tablero = Convert.ToInt32(maskedTextBox2.Text);
        ...
        {
            if (maskedTextBox4.Text.Trim() == "")
            {
                ErrorG.SetError(maskedTextBox4, "Introduce el numero de asteroides que desea generar (Este numero debe ser entre 0-60% de la cuadricula)");
                maskedTextBox4.Focus();
            }
            else
            {
                ErrorG.Clear();
                nast = Convert.ToDouble(maskedTextBox4.Text);
                Datos.nast = maskedTextBox4.Text;
            }
        }
        ...
        {
            // Obtener la instancia de la TableLayoutPanel desde la otra Form
            var form3 = Application.OpenForms.OfType<Form3>().FirstOrDefault();
            var tableLayoutPanel1 = form3?.MiTableLayoutPanel1;

            if (tableLayoutPanel1 != null)
            {
                // Establecer el número de columnas y filas de la TableLayoutPanel
                tableLayoutPanel1.ColumnCount = (int)xtxt_tablero;
                tableLayoutPanel1.RowCount = (int)ytxt_tablero;
            }
